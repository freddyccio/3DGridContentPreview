...
export class GridItem {
    constructor(el) {
        ...
        // translation:
        this.xstart = getRandomNumber(70, 75);
        this.ystart = getRandomNumber(40, 55);
        // rotation:
        this.rxstart = 5;
        this.rystart = 10;
    ...
    layout() {
        ...
        this.tZ = this.isLeft ?
            map(rect.left + rect.width / 2, 0, winsize.width / 2, -450, -500) :
            map(rect.left + rect.width / 2, winsize.width / 2, winsize.width, -500, -450);
